...
namespace AplicatieMagazinOnline.Controllers
{
    public class BooksController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            // Vrem sa avem cate 3 articole pe pg
            int _perPage = 3;
...
/*
        [HttpPost]
        public IActionResult AddCos([FromForm] Cart cart)
        {
...
*//*                if (db.Carts
                    .Where(ab => ab.BookID == cart.BookID)
                    .Count() > 0)
                {
                    TempData["message"] = "Acest articol este deja adaugat in cos";
                ...
                //{
                    ...
                    TempData["message"] = "Articolul a fost adaugat in cos";
            ...
            {
                TempData["message"] = "Nu s-a putut adauga articolul in cos";
                TempData["messageType"] = "alert-danger";
            }

            // Ne intoarcem la pagina articolului
            return Redirect("/Books/Show/" + cart.BookID);
        }
*/
        ...
        public IActionResult New(Book book)
        {
           // book.Date = DateTime.Now;
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    TempData["message"] = "Cartea asteapta aprobarea adminului";
                }
